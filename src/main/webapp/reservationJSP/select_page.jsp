...
<ul>
  <li><a href='listAllReservation.jsp'>List</a> all Emps.  <br><br></li>
  ...
  <li>
     <FORM METHOD="post" ACTION="/restaurant/setReservation" >
       ...
       <select size="1" name="restaurantNo">
         <c:forEach var="reserveTimeVO" items="${reserveTimeServiceImpl.all}" > 
          <option value="${reserveTimeVO.restaurantNo}">${reserveTimeVO.restaurantNo}
         </c:forEach>   
       </select>
       <input type="hidden" name="action" value="getOne_For_Display">
       <input type="submit" value="送出">
