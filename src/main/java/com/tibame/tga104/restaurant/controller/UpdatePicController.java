...
//	查詢該餐廳所有輪播圖片/貼文/菜單
	...
	public ResponseEntity<List> getByRestaurantNo(@PathVariable String management,@PathVariable Integer restaurantNo) {
		switch (management) {
			case "CarouselPic": {
...
//	透過輪播圖片/貼文/菜單的PK進行刪除
	...
	public ResponseEntity<Boolean> deleteByPrimaryKey(@PathVariable String management ,@PathVariable Integer primaryKey) {
		Boolean del = null;
		switch (management) {
			case "CarouselPic": {
