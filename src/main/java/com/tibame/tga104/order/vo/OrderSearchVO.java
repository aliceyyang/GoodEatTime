...
public class OrderSearchVO implements java.io.Serializable{
	...
	public String toString() {
		return "OrderSearchVO [prodOrderNo=" + prodOrderNo + ", memberNo=" + memberNo + ", restaurantNo=" + restaurantNo
				...
				+ invoiceNumber + ", taxIDNumber=" + taxIDNumber + ", restaurantName=" + restaurantName
				+ ", couponName=" + couponName + ", prodNo=" + prodNo + ", prodName=" + prodName + ", prodQty="
				+ prodQty + ", prodPrice=" + prodPrice + ", name=" + name + ", tel=" + tel + "]";
	}
